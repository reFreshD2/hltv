...
class TeamController extends AbstractController
{
    ...
    public function __invoke(): Response
    {
        ...
        usort($teamsStats, function (TeamStatsDTO $statsDTO1, TeamStatsDTO $statsDTO2) {
            return $statsDTO1->getRating() >= $statsDTO2->getRating() ? -1 : 1;
        });

        return $this->render('web/teams/teams-page.html.twig', [
    ...
    public function getTeamView(Request $request, string $id): Response
    {
        ...
        return $this->render('web/teams/team-view-page.html.twig', [
            'teamStats' => $teamStats,
        ]);
    }
}